...
import com.lxtech.ssh.service.business.ReceiveYipayRegistInfoService;
import com.lxtech.ssh.vo.CheckOpenYipayInfo;
import com.lxtech.ssh.vo.YipayAssociatorInfo;

@Service("receiveYipayRegistInfoService")
public class ReceiveYipayRegistInfoServiceImpl implements ReceiveYipayRegistInfoService,MessageListener{
	...
	public void receiveYipayRegistInfo() {
		// TODO Auto-generated method 
				...
				//模拟调用翼支付接口 并解析完毕
				CheckOpenYipayInfo checkOpenYipayInfo = getCheckInfo();
	...
	public CheckOpenYipayInfo getCheckInfo(){
		return null;
	}
	@Override
